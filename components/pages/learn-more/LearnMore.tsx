  ...
  return (
    <Wrapper id={"learn-more"}>
      <Content>
        ...
        <Product title={"Other Polymers"} description={"Recycled PP, LDPE"} image={"/img/learn-more/product.jpg"} />
        <Product title={"Services"} description={""} image={"/img/learn-more/product.jpg"} />
      </Content>
